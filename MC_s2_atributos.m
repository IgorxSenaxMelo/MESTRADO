...
% Apenas incerteza dos especialistas.
% Amostragem empírica das avaliações observadas. (pesos do cenario S2)
for mc = 1:N_mc

   %% MONTE CARLO - SOMENTE ATRIBUTOS
...
% amostragem empírica dos especialistas
